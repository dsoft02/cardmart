...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form id="formProfileUpdate" method="POST" action="{{ route('admin.profile.update') }}">
            @csrf
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if (!auth()->user()->google_id)
                ...
                <form id="formChangePassword" method="POST" action="{{ route('admin.profile.password.update') }}" onsubmit="return false">
                    @csrf
